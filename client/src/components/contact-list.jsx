                ...
                contacts?.map((contact) => (
                    ...
                    >
                        <div className='flex gap-5 items-center justify-start text-neutral-300'>
                            {!isChannel && <Avatar className="sm:h-9 sm:w-9 w-6 h-6 md:w-10 md:h-10 rounded-full overflow-hidden">
                                {
                                    contact.image ?
                                        ...
                                        uppercase sm:h-9 sm:w-9 w-6 h-6 md:w-10 md:h-10  md:text-lg sm:text-[16px] text-sm border-[1px] flex items-center justify-center rounded-full `}>
